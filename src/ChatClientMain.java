...
public class ChatClientMain {
    public static void main(String[] args) {
        // try {
        // if (args.length < 3) {
        // System.out.println("Usage: java ChatClientMain <username> <hostname>
        // <port>");
        // return;
        // }
        ...
        // // try {
        // // port = Integer.parseInt(args[2]); // Ensure port is a valid integer
        ...
        // System.out.println("Connecting to chat server at " + hostname + " on port " +
        // port + "...");

        // System.setProperty("java.rmi.server.hostname", "90.18.203.147");
        ...
        // System.err.println("Error: Cannot connect to RMI registry at " + hostname +
        // ":" + port);
        // e.printStackTrace();
        // return;
        ...
        // return;
        // } catch (Exception e) {
        // System.err.println("Error: Unexpected issue connecting to server: " +
        // e.getMessage());
        // e.printStackTrace();
        // return;
        // }

        // // Get registry from provided hostname
        ...
        // System.out.println("Type messages, 'history' to show previous messages, or
        // 'exit' to quit:");
